...
/* harmony export */   createTaskCompletionListener: () => (/* binding */ createTaskCompletionListener)
/* harmony export */ });
...
function createTaskCompletionListener(checkbox) {
    checkbox.addEventListener("click", () => {
        function setCurrentTaskFromID(taskID) {
            (0,_models_organizers_project__WEBPACK_IMPORTED_MODULE_1__.getCurrentProject)().getIncompleteTasks().forEach(task => {
        ...
        (0,_models_organizers_task__WEBPACK_IMPORTED_MODULE_2__.completeTask)((0,_models_organizers_project__WEBPACK_IMPORTED_MODULE_1__.getCurrentProject)().getCurrentTask());
        ...
        ;(0,_models_organizers_project__WEBPACK_IMPORTED_MODULE_1__.getCurrentProject)().removeFromIncompleteTasks((0,_models_organizers_project__WEBPACK_IMPORTED_MODULE_1__.getCurrentProject)().getCurrentTask());
        // Move the task card to completed tasks section of project and add 'completed' class
        (0,_pages_projectPage_tasksCardHandler__WEBPACK_IMPORTED_MODULE_4__.setTaskCardCompleted)((0,_models_organizers_project__WEBPACK_IMPORTED_MODULE_1__.getCurrentProject)().getCurrentTask());
    });
}
...
function createStepCompletionListener(checkbox) {
    checkbox.addEventListener("click", () => {
        ...
        (0,_models_organizers_project__WEBPACK_IMPORTED_MODULE_1__.getCurrentProject)().getCurrentTask().removeFromIncompleteSteps((0,_models_organizers_project__WEBPACK_IMPORTED_MODULE_1__.getCurrentProject)().getCurrentTask().getCurrentStep());
        // Move the step card to bottom of current task and add 'completed' class
        (0,_pages_projectPage_stepsCardHandler__WEBPACK_IMPORTED_MODULE_3__.setStepCardCompleted)((0,_models_organizers_project__WEBPACK_IMPORTED_MODULE_1__.getCurrentProject)().getCurrentTask().getCurrentStep());
    });
}
...
function generateTaskCards(tasks, parent) {
    ...
    function generateTask(task) {
        ...
        function generateTaskHeader(task) {
            ...
            (0,_modules_eventListeners_checkboxListeners_js__WEBPACK_IMPORTED_MODULE_5__.createTaskCompletionListener)(completedCheckbox);
